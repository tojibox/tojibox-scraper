...
-- Additive migration for the Togibox/GIWA oracle pipeline, layered onto the
...
-- would race to mark the same row committed — Togibox committing an
...
-- No row-level conflict here even though the table is shared — Togibox's
